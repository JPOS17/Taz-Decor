      ...
      <tr>
        <td style="padding: 16px; border-bottom: 1px solid #e2e8f0;">
          <div style="display: flex; align-items: center; gap: 16px;">
            ${
              item.img_url
                ? `<img src="${item.img_url}" alt="${item.product_name}" style="width: 60px; height: 60px; object-fit: cover; border-radius: 8px;" />`
                : ""
            }
            <div>
          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="section">
                ...
                <div class="summary-row">
                  <span>Shipping:</span>
                  <span>${orderData.shipping_cost === 0 ? "FREE" : `$${orderData.shipping_cost.toFixed(2)}`}</span>
                </div>
                <div class="summary-row">
                  <span>Tax:</span>
              ...
              <div style="background: #fffbeb; border: 1px solid #fde68a; border-radius: 8px; padding: 20px; margin: 20px 0; text-align: center;">
                ...
                <div style="font-family: monospace; font-size: 18px; font-weight: bold; color: #1a202c; background: white; border: 1px solid #fde68a; border-radius: 6px; padding: 10px 20px; display: inline-block;">
              ...
              <center>
                <a href="${orderUrl}" class="button">${isGuest ? "Look Up My Order" : "View Order Details"}</a>
              </center>
...
/**
 * Send shipping notification email to customer with USPS tracking
 */
export const sendShippingNotificationEmail = async (
  ...
  const mailOptions = {
    from: process.env.EMAIL_FROM || process.env.EMAIL_USER,
    to: email,
    subject: `Your Order #${orderData.order_number} Has Shipped! 📦`,
    html: `
      <!DOCTYPE html>
      <html>
        <head>
            ...
            <div class="content">
              ...
              <div class="section">
                ...
                <div class="info-row">
                  ...
                  <span style="font-weight: bold;">#${orderData.order_number}</span>
                </div>
                <div class="info-row">
                  <span style="color: #666;">Order Total:</span>
                  <span style="font-weight: bold;">$${orderData.total_price.toFixed(2)}</span>
                </div>
                <div class="info-row">
                  <span style="color: #666;">Carrier:</span>
                  <span style="font-weight: bold;">USPS</span>
                </div>
              </div>
              ...
              <center>
                <a href="${uspsTrackingUrl}" class="button">Track Your Package</a>
              </center>

              ${isGuest ? `
              <center>
                <a href="${orderUrl}" style="display: inline-block; margin-top: 8px; color: #667eea; font-size: 14px;">View Order Details</a>
              </center>
              ` : ""}

              <p style="text-align: center; color: #718096; font-size: 14px; margin-top: 16px;">
                Or copy and paste this tracking link in your browser:
              </p>
              ...
              <div style="border-top: 2px solid #e2e8f0; padding-top: 20px; margin-top: 24px;">
                <p style="margin: 0 0 8px 0; font-size: 16px; color: #1a202c;">
...
/**
 * Send custom message from admin to user
 */
    ...
    html: `
      ...
      <html>
        ...
        <body>
          <div class="container">
            <div class="header">
              <h1>Message from Store Admin</h1>
            </div>
            <div class="content">
              <h2>Hi ${firstName},</h2>
              <div class="message">
